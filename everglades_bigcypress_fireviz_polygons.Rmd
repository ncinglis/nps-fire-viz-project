...
plot_mapbox(share, color=~NEWCAT, colors=pal,
            ...
            text=~paste('Name:', FIRE_NAME, '<br>Park:', UnitName.x, '<br>Type:', NEWCAT, '<br>Date:', format(StartDate, "%b %d %Y"), '<br>Duration:', duration, "days", '<br>WFU?:', ifelse(FireTypePr==14 | FireTypePr==49, "Yes", "No"), "<br>Size:", format(ContrAcres, big.mark = ",", digits = 1), "acres"), hoverinfo="text") %>% 
