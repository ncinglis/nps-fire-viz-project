...
```{r cars, echo=F, warning=F, message=F, fig.width=16, fig.height=16}
 library(crosstalk)
...
####Hover over a color on either chart below to explore how each fire type is distributed throughout history and across the year
```{r, echo=F, warning=F, message=F, fig.width=14, fig.height=6, fig.align='center'}
...
subplot(p2g, p1g, which_layout = 2) %>% hide_legend() %>% highlight("plotly_hover")
```
