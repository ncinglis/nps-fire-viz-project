...
devtools::install_github("tidyverse/ggplot2")devtools::install_github("tidyverse/ggplot2")
...
bubble <- ggplot(firessf, aes(y=FIRE_YEAR)) +
...
map<- plot_ly(firessf,
              color=~NEWCAT,
              colors= c("#ffff00", "#ff5733", "#56b4e9", "#d397fc"),
              text = ~paste("Name: ", IncidentNa,"\n Type: ",NEWCAT, "\n Duration: ", duration), 
              hoverinfo = "text")
 library(crosstalk)
